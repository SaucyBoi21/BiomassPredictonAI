...
img_name = 'T02_GH13_JC01_Jan-27-2023_1741_rgb'

# give img location use "/" instead of "\"
path = f'C:/Users/jcard/Documents/GitHub/BiomassPredictonAI/image_processing/rgb_images/tray_2/raw_images/{img_name}.jpg'
path_analyzed_imgs = 'C:/Users/jcard/Documents/GitHub/BiomassPredictonAI/image_processing/rgb_images/tray_2/analyzed_imgs'
path_result = 'C:/Users/jcard/Documents/GitHub/BiomassPredictonAI/image_processing/rgb_images/tray_2/results_csv'
...
img = pcv.crop(img=raw_img, x=15, y=80, h=885, w=1850)
pcv.plot_image(img)
...
pcv.outputs.save_results(filename = f"C:/Users/jcard/Documents/GitHub/BiomassPredictonAI/image_processing/rgb_images/tray_2/csv_plantcv/pcv_{img_name}.csv", outformat="csv")
pcv.outputs.clear()