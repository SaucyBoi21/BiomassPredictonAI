...
path_rgb = 'test_imgs/continous/RGB'
path_trans ='test_imgs/continous/DEPTH'
path_csv_depth = 'test_imgs/continous/DEPTH_CSV'  
...
def get_img():
    ...
    trans_handle = Transformation(calibration)
