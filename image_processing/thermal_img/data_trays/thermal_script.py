...
bin_mask = pcv.threshold.binary(gray_img=thermal_data, threshold=thermal_data.max(), max_value=255, object_type='dark')
...
roi, roi_hierarchy= pcv.roi.rectangle(img=scaled_thermal_img, x=0, y=0, h=210, w=300)
...
pseudo_img = pcv.visualize.pseudocolor(gray_img = thermal_data, mask=bin_mask, cmap='jet', 
