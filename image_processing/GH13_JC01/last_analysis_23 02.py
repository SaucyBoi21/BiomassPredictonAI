...
filename = 'C:/Users/jcard/OneDrive - University of Georgia/kinect_imaging/GH13_JC01/rgb_imgs/tray_2/raw_images/T02_GH13_JC01_Feb-23-2023_0732_rgb.jpg'
...
#t01 =  x=0, y=70, h=905, w=1920
#t03 =  x=0, y=110, h=900, w=1920
...
histogram, bin_edges = np.histogram(hsv_s, bins=256, range=(0, 300))
fig, ax = plt.subplots()
...
thresh = pcv.threshold.binary(gray_img=hsv_s, threshold=139, max_value=255, object_type='light')
...
h_fill = pcv.fill(thresh,size = 1000)
...
rois, roi_hierarchy = pcv.roi.multi(img=img, coord=(125,125), radius=25, 
...
pcv.outputs.save_results(filename = f"C:/Users/jcard/OneDrive - University of Georgia/kinect_imaging/GH13_JC01/rgb_imgs/tray_2/csv_plantcv/pcv_{img_name}.csv", outformat="csv")
pcv.outputs.clear()
