...
path_color = "C:/Users/jcard/OneDrive - University of Georgia/kinect_imaging/GH13_JC01/rgb_imgs/tray_1/raw_images/T01_GH13_JC01_Feb-09-2023_0749_rgb.jpg"
path_depth_csv = 'C:/Users/jcard/OneDrive - University of Georgia/kinect_imaging/GH13_JC01/depth_csv/tray_1/T01_GH13_JC01_Feb-09-2023_0749_depth_values.csv'
...
histogram_depth, bin_edges = np.histogram(img, bins=256, range=(1200, 1300))
fig, ax = plt.subplots()
...
hsv_h = pcv.rgb2gray_hsv(rgb_img=color_img, channel='s')
...
rois, roi_hierarchy = pcv.roi.rectangle(scaled_distance_img, x=100, y=100, h=885, w=1800)
...
analysis_thermal = pcv.analyze_thermal_values(img, plant_mask, histplot=True, label='area')
