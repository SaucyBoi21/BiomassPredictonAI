...
img_name = 'T03_GH13_JC01_Feb-02-2023_0743_rgb'

# give img location use "/" instead of "\"
path = f'C:/Users/jcard/OneDrive - University of Georgia/kinect_imaging/GH13_JC01/rgb_imgs/tray_3/raw_images/{img_name}.jpg'
path_analyzed_imgs = 'C:/Users/jcard/OneDrive - University of Georgia/kinect_imaging/GH13_JC01/rgb_imgs/tray_3/analyzed_imgs'
path_result = 'C:/Users/jcard/OneDrive - University of Georgia/kinect_imaging/GH13_JC01/rgb_imgs/tray_3/results_csv'
...
img = pcv.crop(img=raw_img, x=25, y=120, h=885, w=1850)
pcv.plot_image(img)
...
thresh = pcv.threshold.binary(gray_img=hsv_s, threshold=80, max_value=255, object_type='dark')
...
pcv.outputs.save_results(filename = f"C:/Users/jcard/OneDrive - University of Georgia/kinect_imaging/GH13_JC01/rgb_imgs/tray_3/csv_plantcv/pcv_{img_name}.csv", outformat="csv")
pcv.outputs.clear()