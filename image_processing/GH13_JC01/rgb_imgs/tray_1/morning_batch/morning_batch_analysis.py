...
filenames = sorted(glob.glob('C:/Users/jcard/OneDrive - University of Georgia/kinect_imaging/GH13_JC01/rgb_imgs/tray_1/morning_batch/raw_images/T01*.jpg'))
...
#img_name to avoid changing name in every path or when storing results  
    ...
    path_analyzed_imgs = 'C:/Users/jcard/OneDrive - University of Georgia/kinect_imaging/GH13_JC01/rgb_imgs/tray_1/morning_batch/analyzed_imgs'
    path_result = 'C:/Users/jcard/OneDrive - University of Georgia/kinect_imaging/GH13_JC01/rgb_imgs/tray_1/morning_batch/results_csv'
    path_segmentation = 'C:/Users/jcard/OneDrive - University of Georgia/kinect_imaging/GH13_JC01/rgb_imgs/tray_1/morning_batch/morning_segmentation.txt'
    ...
    img = pcv.crop(img=raw_img, x=0, y=70, h=905, w=1920)
    pcv.plot_image(img)
    ...
    pcv.outputs.save_results(filename = f"C:/Users/jcard/OneDrive - University of Georgia/kinect_imaging/GH13_JC01/rgb_imgs/tray_1/morning_batch/csv_plantcv/pcv_{img_name}.csv", outformat="csv")
    pcv.outputs.clear()
