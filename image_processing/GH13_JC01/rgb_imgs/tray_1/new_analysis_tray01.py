...
path_segmentation = 'C:/Users/jcard/OneDrive - University of Georgia/kinect_imaging/GH13_JC01/rgb_imgs/tray_1/plant_segmentation.txt'
# tray_number = 1
...
thresh = pcv.threshold.binary(gray_img=hsv_s, threshold=137, max_value=255, object_type='light')
...
h_fill = pcv.fill(thresh, size=100)
