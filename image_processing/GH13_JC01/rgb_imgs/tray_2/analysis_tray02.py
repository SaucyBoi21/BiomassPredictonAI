...
img_name = 'T02_GH13_JC01_Feb-16-2023_0751_rgb'
...
img = pcv.crop(img=raw_img, x=0, y=75, h=885, w=1850)
pcv.plot_image(img)
...
thresh = pcv.threshold.binary(gray_img=hsv_s, threshold=80, max_value=255, object_type='light')
