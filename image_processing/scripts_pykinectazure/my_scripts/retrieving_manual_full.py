...
path_csv_depth = 'C:/Users/jcard/OneDrive - University of Georgia/kinect_imaging/scripts_pykinectazure/my_scripts/depth_csv' 
...
cv2.imwrite(os.path.join(path_trans, tray_ID + crop_code + timestamp + "_transformed.jpg"), transformed_numpy)
# =============================================================================
# 
...
np.savetxt(os.path.join(path_csv_depth,tray_ID + crop_code + timestamp + "_depth_values.csv"), transformed_numpy, delimiter=",")
...
cv2.imwrite(os.path.join(path_rgb,tray_ID + crop_code + timestamp + "_rgb.jpg"), color_ref)
