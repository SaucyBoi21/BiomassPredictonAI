...
model = pickle.load(open(r"C:\Users\klimesp\Dropbox\Programovani\Python\USA\RF_model_230505","rb"))
#model = pickle.load(open("RF_model_400x400_230307","rb"))

path_images = r"C:\Users\klimesp\Dropbox\Programovani\Python\USA\1\*.jpg"
DEBUG = False
...
for id,file in enumerate( glob.glob(path_images)[2:3]):
    ...
    trashold = 100
    blur[blur >= trashold] = 255
    blur[blur < trashold] = 0
    plt.imshow(blur)
